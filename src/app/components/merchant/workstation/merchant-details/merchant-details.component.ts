...
// import { newTellerModel } from '../../merchant.models';
...
export class MerchantDetailsComponent {
  ...
  //     @ViewChild('closeMetadataModal') closeMetadataModal: any;
  //     selectedMenu = '';
  //     selectedSubMenu = '';
  //     isLoading = false;
  //     merchantId = '';
  //     inputActive: any = false;
  //     updateLogo = false;
  ...
  //     merchantForm: any = this.fb.group({
  ...
  //     topClientsByAmount: any;
  //     topClientsByTransactions: any;
  //     selectedOption: any;
  //     paymentStats: any;
  ...
  //             plug: this?.merchant?.api_plugin_name,
  ...
  //                             plug: this.merchant.api_plugin_name,
  //                             incognito:
  //                                 this.merchant.client_visibility_activated,
  //                             cashin: this.merchant.has_cashin,
  //                         });
  //                         if (this.merchant.merchant_location) {
  //                             this.longitude =
  //                                 this.merchant.merchant_location.longitude;
  //                             this.latitude =
  //                                 this.merchant.merchant_location.latitude;
  //                         }
  ...
  //             .subscribe((tellers: any) => {
  //                 this.tellers = tellers.objects;
  //             });
  //     }
  //     displayTellerInfo(teller: any) {
  ...
  //             if (
  //                 action === 'accepts_cart' &&
  //                 !this.action.includes('accepts_cart')
  //             ) {
  ...
  //                 });
  //                 this.action = this.action.filter(
  //                     (act: string) => act !== 'invisible'
  //                 );
  //                 this.action.push(action);
  //             } else if (
  //                 action === 'invisible' &&
  //                 !this.action.includes('invisible')
  //             ) {
  //                 this.merchantConfigForm.patchValue({
  //                     incognitoMerchant: false,
  //                 });
  //                 this.action = this.action.filter(
  //                     (act: string) => act !== 'visible'
  //                 );
  //                 this.action.push(action);
  //             }
  ...
  //             if (
  //                 action === 'has_cashin' &&
  //                 !this.action.includes('has_cashin')
  //             ) {
  //                 this.merchantConfigForm.patchValue({
  //                     cashin: true,
  //                 });
