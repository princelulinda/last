...
@Component({
  selector: 'app-operator-design-test',
  standalone: true,
  imports: [CommonModule, MultiSelectComponent, ReactiveFormsModule],
  templateUrl: './operator-design-test.component.html',
  styleUrl: './operator-design-test.component.scss',
})
export class OperatorDesignTestComponent implements OnInit, OnDestroy {
